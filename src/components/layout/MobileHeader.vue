  ...
  <header class="lg:hidden sticky top-0 z-40 bg-white border-b border-gray-200">
    <div class="flex items-center justify-between h-14 px-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-base font-bold text-gray-900">{{ pageTitle }}</span>
      </div>
    ...
    <Transition name="menu">
      <div
        v-if="showMenu"
        class="absolute top-14 left-0 right-0 bg-white border-b border-gray-100 shadow-md z-50"
      >
        <!-- Backdrop -->
        ...
        <div class="px-4 py-3">
          ...
          <!-- Sign out button -->
          <button
            class="w-full flex items-center gap-2.5 px-3 py-2.5 text-red-600 hover:bg-red-50 active:bg-red-100 rounded-xl transition-colors text-sm font-medium"
            @click="handleLogout"
          >

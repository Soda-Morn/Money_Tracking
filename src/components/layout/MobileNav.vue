...
<template>
  ...
  <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 z-50 nav-safe-bottom">
    <div class="flex justify-around items-center h-16 px-1">
      ...
      >
        ...
        <!-- Savings Icon -->
        <svg v-else-if="item.icon === 'savings'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Borrow Icon -->
        <svg v-else-if="item.icon === 'borrow'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
